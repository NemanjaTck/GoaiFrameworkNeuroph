 ...
 * @author vladimir
 */
public class WekaClassifierEvaluation extends ClassifierEvaluationBase <double[], String, weka.classifiers.Classifier, Instances> {

    String[] classNames; // temprary solution before we support column names in dataset
    
    public WekaClassifierEvaluation(weka.classifiers.Classifier classifierSrc, Instances problemSrc) {
