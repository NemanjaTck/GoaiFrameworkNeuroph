 ...
 */
public class ClassificationResult <I, C> {
    I item;
    public C targetClass;
    C classifiedClass;
    public boolean isCorrect;

    public ClassificationResult(I item, C targetClass, C classifiedClass) {
        this.item = item;
        this.targetClass = targetClass;
        this.classifiedClass = classifiedClass;
        
        if (classifiedClass.equals(targetClass)) {
            isCorrect = true;
        } else {
            isCorrect = false;
        }                    
